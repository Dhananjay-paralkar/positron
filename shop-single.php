                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row">
                                    <label for="exampleDataList" class="form-label">Select Duration For rent:</label>
...
<!--                                        <button type="submit"  href="checkout.php" class="btn btn-info btn-lg"  value="buy">Rent Now</button>-->
                                        <a class="btn btn-primary btn btn-info btn-lg" href="cart.php" value="buy" type="submit" role="button">Rent Not</a>
                                    </div>
                                    <div class="col d-grid">
                                        <button type="submit" class="btn btn-success btn-lg" name="submit" onclick="addToCart()" value="addtocard">Add To Cart</button>
                                    </div>
                                </div>
                            </form>
