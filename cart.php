...
<div class="container padding-bottom-3x mb-1">
  ...
  <div class="table-responsive shopping-cart">
    <table class="table">
      ...
      <tr>
        ...
        <td class="text-center text-lg text-medium">2 Month</td>
  ...
  <div class="shopping-cart-footer">
    ...
    <div class="column"><a class="btn btn-primary" href="cart.html" data-toast="" data-toast-type="success" data-toast-position="topRight" data-toast-icon="icon-circle-check" data-toast-title="Your cart" data-toast-message="is updated successfully!">Update Cart</a>
      <a class="btn btn-success" href="checkout.php">Checkout</a></div>
  </div>
</div>
</body>
</html>